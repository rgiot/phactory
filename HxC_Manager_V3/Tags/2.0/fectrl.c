...
int main(int argc, char* argv[])
{
	...
	hxc_printf_box("Detecting HxC Floppy Emulator...                                                ");
	if(media_init())
	{
				...
				do
				{
					...
					if(1)
					{
						...
						case 0xFC: // ESC
							...
							hxc_fastprintf( 0, PATH_Y_POS, "Save ? (Y/N)" );
							...
							if ( (key=='y')||(key=='Y'))
							{
								hxc_printf_box("Writing configuration file...");
								save_cfg_file(sdfecfg_file);
							}

							hxc_printf_box("Leaving...");
							move_to_track(0);
							return 0;
							break;
